    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="d-flex my-3">
            <button class="btn btn-teal mx-auto px-4" data-bs-dismiss="modal" data-bs-target="#${nextModalID ? nextModalID : modalId}" data-bs-toggle="modal" id="${submitBtnID}">Start Selling</button>
          </div>
        </div>
      </div>
    </div>
